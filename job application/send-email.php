...
<head>
    ...
    <meta name="description" content="MInistry of Innovation and technology - Job Application Form Wizard with Resume upload and more features ">
    <meta name="author" content="Odhiambo">
    <title>MInt | Job Application </title>
...
//ini_set("smtp_port", "587");
	$mail = $_POST['email'];
	$to = "dagiovoxo@gmail.com";/* YOUR EMAIL HERE */
	$subject = "Job application for Ministry of Inovation and Technology";
	$headers = "From: Job application from Ministry of Innovation and technology <noreply@youremail.com>";
	...
	while (file_exists( 'upload_files/'.$FinalFilename )) // The folder where the files will be stored; set the permission folder to  0755. 
		...
		$userheaders = "From: Job application from MInistry of Innovation and technology <noreply@yourdomain.com>";
